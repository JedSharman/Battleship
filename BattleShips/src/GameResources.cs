...
public static class GameResources
{
	...
	private static void PlaySwinGameIntro()
	{
		...
		for (i = 0; i <= ANI_CELL_COUNT - 1; i++) {
			SwinGame.DrawBitmap(_Background, 0, 0);
			/*
				JED Mangled Creation
				DrawBitmap replacing old function
			*/
	...
	private static void ShowMessage(string message, int number)
	{
		...
		*/
		...
		SwinGame.DrawText(message, Color.White, Color.Transparent, _LoadingFont, FontAlignment.AlignCenter,r);
	...
	private static void EndLoadingScreen(int width, int height)
	{
		...
		/*
			JED MANGLED
			Audio.FreeSoundEffect is broken in the swingame dll
		*/
	...
	{		
		...
		/*
		 * JED MANGLED
		 * FreeSounds() calls Audio.FreeSoundEffect which is broken in the swingame dll
		*/
		//FreeSounds();
		SwinGame.ProcessEvents();
	}
